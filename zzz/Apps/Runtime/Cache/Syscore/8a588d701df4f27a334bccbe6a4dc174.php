            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <div class="col-md-12 margin-top-10 margin-bottom-10">
                        <div class="col-md-8">
                            <button type="button" class="btn green" onclick="javascript:window.location.href='<?php echo U('Sort/edit?moduleid='.$moduleid.'&lan='.I('get.lan'));?>'"><?php echo (L("v_add")); ?> <?php echo (L("v_sort")); ?></button>
                        </div>
                            ...
                            <tbody>
                              <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$rs): $mod = ($i % 2 );++$i;?><input type="hidden" name="id[]" value="<?php echo ($rs["id"]); ?>" />
                                <tr class="odd gradeX">
                                    ...
                                    <td><?php echo ($rs['html']); ?> <?php echo ($rs['title']); ?></td>
