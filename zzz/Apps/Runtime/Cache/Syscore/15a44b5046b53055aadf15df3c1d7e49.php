                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li><span><?php echo (L("v_global")); ?></span><i class="fa fa-angle-right"></i></li>
                            <li><span><?php echo (L("v_field")); ?> <?php echo (L("v_manage")); ?></span></li>
                        </ul>
                    </div>
                    <!--页面导航 结束-->
                    <!--页面头部 结束-->
                    ...
                    <div class="col-md-12 margin-top-10 margin-bottom-10">
                        <button type="button" class="btn green" onclick="javascript:window.location.href='<?php echo U('Field/edit?fieldtype=text&lan='.I('get.lan'));?>'"><?php echo (L("v_add")); ?> <?php echo (L("v_method_text")); ?> <?php echo (L("v_field")); ?></button>
                        <button type="button" class="btn green-meadow" onclick="javascript:window.location.href='<?php echo U('Field/edit?fieldtype=textarea&lan='.I('get.lan'));?>'"><?php echo (L("v_add")); ?> <?php echo (L("v_method_textarea")); ?> <?php echo (L("v_field")); ?></button>
                        <button type="button" class="btn green" onclick="javascript:window.location.href='<?php echo U('Field/edit?fieldtype=imgupload&lan='.I('get.lan'));?>'"><?php echo (L("v_add")); ?> <?php echo (L("v_img")); ?> <?php echo (L("v_field")); ?></button>
                        <button type="button" class="btn green-meadow" onclick="javascript:window.location.href='<?php echo U('Field/edit?fieldtype=fileupload&lan='.I('get.lan'));?>'"><?php echo (L("v_add")); ?> <?php echo (L("v_file")); ?> <?php echo (L("v_field")); ?></button>
                        <button type="button" class="btn green" onclick="javascript:window.location.href='<?php echo U('Field/edit?fieldtype=richtext&lan='.I('get.lan'));?>'"><?php echo (L("v_add")); ?> <?php echo (L("v_editor")); ?> <?php echo (L("v_field")); ?></button>
                    </div>
                    <form name="form2" id="form2" action="" method="post">
                        <table class="table table-striped table-bordered table-hover table-checkable order-column">
                            <thead>
                                <tr class="bg-default">
                                    <th>ID</th>
                                    <th><?php echo (L("v_field")); ?> <?php echo (L("v_label")); ?></th>
                                    <th><?php echo (L("v_field")); ?> <?php echo (L("v_description")); ?></th>
                                    <th><?php echo (L("v_field")); ?> <?php echo (L("v_content_a")); ?></th>
                            ...
                            <tbody>
                              <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$rs): $mod = ($i % 2 );++$i;?><input type="hidden" name="id[]" value="<?php echo ($rs["id"]); ?>" />
                                <tr class="odd gradeX">
                                    ...
                                    <td><input name="fieldlabel[]" type="text" value="<?php echo ($rs['fieldlabel']); ?>" class="form-control input-sm" /></td>
                                    <td><input name="fieldtext[]" type="text" value="<?php echo ($rs['fieldtext']); ?>" class="form-control input-sm" /></td>
                                    <td><div class="lh26"><?php echo (mb_substr($rs['fieldvalue'],0,24,'utf-8')); ?></div></td>
                                    ...
                                    <td><a href="<?php echo U('Field/edit?fieldtype='.$rs['fieldtype'].'&lan='.I('get.lan').'&id='.$rs['id']);?>" class="btn green btn-sm"><i class="fa fa-edit"></i> <?php echo (L("v_edit")); ?></a><a class="btn red-flamingo btn-sm" onClick='return confirm("<?php echo (L("v_confirm_delete")); ?>！");' href="/zzz/hetada/field/delete_one/id/<?php echo ($rs["id"]); ?>"><i class="fa fa-times"></i> <?php echo (L("v_delete")); ?></a></td>
                                </tr><?php endforeach; endif; else: echo "$empty" ;endif; ?>
                                <tr>
                                    <td colspan="6">
                                        <div class="fl pdl7 lh34"><div class="pages"><?php echo ($page); ?></div></div>
                                        <div class="fr pdr5"><button type="button" class="btn blue" onclick="CheckOthers(this.form);"><i class="fa fa-check"></i> <?php echo (L("v_select_all")); ?></button><button type="button" class="btn green" onClick='ConfirmDel("","/zzz/hetada/field/update_all/","update");'><i class="fa fa-arrow-circle-o-up"></i> <?php echo (L("v_update_all")); ?></button><button type="button" class="btn red-flamingo" onClick='ConfirmDel("<?php echo (L("v_confirm_delete")); ?>！","/zzz/hetada/field/delete_all/","delete");'><i class="fa fa-times"></i> <?php echo (L("v_delete_select")); ?></button></div>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
