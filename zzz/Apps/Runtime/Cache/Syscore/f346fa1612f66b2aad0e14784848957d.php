                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li><span><?php echo (L("v_global")); ?></span><i class="fa fa-angle-right"></i></li>
                            <li><span><?php echo (L("v_ad")); ?> <?php echo (L("v_manage")); ?></span></li>
                        </ul>
                    </div>
                    <!--页面导航 结束-->
                    <!--页面头部 结束-->
                    ...
                    <div class="col-md-12 margin-top-10 margin-bottom-10">
                        <button type="button" class="btn green" onclick="javascript:window.location.href='<?php echo U('Ad/edit?lan='.I('get.lan'));?>'"><?php echo (L("v_add")); ?> <?php echo (L("v_ad")); ?></button>
                    </div>
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column">
                            <thead>
                                <tr class="bg-default">
                                    ...
                                    <th><?php echo (L("v_img")); ?></th>
                                    <th><?php echo (L("v_type")); ?></th>
                                    <th><?php echo (L("v_position")); ?></th>
                            ...
                            <tbody>
                              <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$rs): $mod = ($i % 2 );++$i;?><input type="hidden" name="id[]" value="<?php echo ($rs["id"]); ?>" />
                                <tr class="odd gradeX">
                                    ...
                                    <td><a href="<?php echo ($rs['imgurl']); ?>" target="_blank"><img src="<?php echo ($rs['imgurl']); ?>" width="300" border="0" /></a></td>
                                    <td>
						                <?php switch($rs["typeid"]): case "1": echo (L("v_banner")); break;?>
                                            <?php case "2": echo (L("v_friendlink")); break;?>
                                            <?php default: echo (L("v_banner")); endswitch;?>
                                    </td>
                                    <td>
						                <?php switch($rs["position"]): case "Index": echo (L("v_index")); break;?>
                                            <?php case "Product": echo (L("v_product")); break;?>
                                            <?php case "News": echo (L("v_news")); break;?>
                                            <?php case "Down": echo (L("v_down")); break;?>
                                            <?php case "Page": echo (L("v_page_module")); break;?>
                                            <?php case "Project": echo (L("v_project")); break;?>
                                            <?php default: echo ($rs['position']); endswitch; echo (L("v_module")); ?>&nbsp;&nbsp;
                                    </td>
