                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li><span><?php echo (L("v_product_manage")); ?></span><i class="fa fa-angle-right"></i></li>
                            <li><span><?php echo (L("v_product_manage")); ?></span></li>
                        </ul>
                        <div class="page-toolbar">
                            <div class="btn-group pull-right">
                                <button type="button" class="btn green btn-sm dropdown-toggle" data-toggle="dropdown"><i class="fa fa-file-excel-o"></i> Excel 批量操作 <i class="fa fa-angle-down"></i>
                                </button>
                                <ul class="dropdown-menu pull-right" role="menu">
                                    <li><a href="<?php echo U('Customer/excelexport');?>" class="font-green-jungle bold" data-target="#ajax" data-toggle="modal"><i class="fa fa-file-excel-o"></i> 导出到 Excel <i class="fa fa-share font-green-jungle"></i></a></li>
                                    <li><a href="<?php echo U('Customer/excelimport');?>" class="font-red bold" data-target="#ajax" data-toggle="modal"><i class="fa fa-file-excel-o"></i> Excel 批量导入 <i class="fa fa-reply font-red"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 margin-top-10 margin-bottom-10">
                        <div class="col-md-8">
                            ...
                            <?php if((in_array('addinfo',$isdisplay_array))): ?><button type="button" class="btn green" onclick="javascript:window.location.href='<?php echo U('Product/edit?moduleid='.I('get.moduleid').'&lan='.I('get.lan'));?>'"><?php echo (L("v_add")); ?> <?php echo (L("v_product")); ?></button><?php endif; ?>
                        </div>
                    ...
                    <form name="form2" id="form2" action="" method="post">
                        <table class="table table-striped table-bordered table-hover table-checkable order-column">
                            <thead>
                                <tr class="bg-default">
                                    <th>ID</th>
                                    <th><?php echo (L("v_belong_sort")); ?></th>
                                    <th><?php echo (L("v_title")); ?></th>
...
<div class="modal fade" id="ajax" role="basic" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body"><img src="/zzz/Public/bootstrap/global/img/input-spinner.gif" alt="" class="loading"><span> &nbsp;&nbsp;Loading... </span>
            </div>
        </div>
    </div>
</div>
