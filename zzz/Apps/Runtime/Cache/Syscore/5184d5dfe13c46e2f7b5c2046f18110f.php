                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li><span><?php echo (L("v_project_manage")); ?></span><i class="fa fa-angle-right"></i></li>
                            <li><span><?php echo (L("v_project_manage")); ?></span></li>
                        </ul>
                    </div>
                    <!--页面导航 结束-->
                    <!--页面头部 结束-->
                    ...
                    <div class="col-md-12 margin-top-10 margin-bottom-10">
                        <div class="col-md-8">
                            ...
                            <?php if((in_array('addinfo',$isdisplay_array))): ?><button type="button" class="btn green" onclick="javascript:window.location.href='<?php echo U('Project/edit?moduleid='.I('get.moduleid').'&lan='.I('get.lan'));?>'"><?php echo (L("v_add")); ?> <?php echo (L("v_project")); ?></button><?php endif; ?>
                        </div>
