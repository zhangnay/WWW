                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li><span>
						    <?php switch($modulenav["id"]): case "1": echo (L("v_product")); break;?>
                                <?php case "2": echo (L("v_news")); break;?>
                                <?php case "3": echo (L("v_down")); break;?>
                                <?php case "4": echo (L("v_page_module")); break;?>
                                <?php case "5": echo (L("v_project")); break;?>
                                <?php default: echo ($modulenav['modulename']); endswitch;?>
                                <?php echo (L("v_manage")); ?></span><i class="fa fa-angle-right"></i></li>
                            <li><span>
						    <?php switch($modulenav["id"]): case "1": echo (L("v_product")); break;?>
                                <?php case "2": echo (L("v_news")); break;?>
                                <?php case "3": echo (L("v_down")); break;?>
                                ...
                                <?php case "5": echo (L("v_project")); break;?>
                                <?php default: echo ($modulenav['modulename']); endswitch;?>
                            <?php echo (L("v_attribute")); ?></span></li>
                        </ul>
                    </div>
                    <!--页面导航 结束-->
                    <!--页面头部 结束-->
                    ...
                    <div class="col-md-12 margin-top-10 margin-bottom-10">
                        <div class="col-md-8">
                            <button type="button" class="btn green" onclick="javascript:window.location.href='<?php echo U('Attribute/edit?moduleid='.I('get.moduleid').'&lan='.I('get.lan'));?>'"><?php echo (L("v_add")); ?> <?php echo (L("v_attribute")); ?></button>
                        </div>
                    ...
                    <form name="form2" id="form2" action="" method="post">
                        <table class="table table-striped table-bordered table-hover table-checkable order-column">
                            <thead>
                                <tr class="bg-default">
                                    <th>ID</th>
                                    <th><?php echo (L("v_attribute_name")); ?></th>
                                    <th><?php echo (L("v_attribute_value")); ?></th>
                                    <th><?php echo (L("v_belong_sort")); ?></th>
                                    <th><?php echo (L("v_add_method")); ?></th>
                            ...
                            <tbody>
                              <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$rs): $mod = ($i % 2 );++$i;?><input type="hidden" name="id[]" value="<?php echo ($rs["id"]); ?>" />
                                <tr class="odd gradeX">
                                    ...
                                    <td><?php echo ($rs["attname"]); ?></td>
                                    <td><?php echo ($rs["attvalue"]); ?></td>
                                    <td><?php echo ($rs["title"]); ?></td>
                                    <td>
						                <?php switch($rs["fieldtype"]): case "2": echo (L("v_method_checkbox")); break;?>
                                            <?php case "3": echo (L("v_method_text")); break;?>
                                            <?php case "4": echo (L("v_method_textarea")); break;?>
                                            <?php default: echo (L("v_method_select")); endswitch;?>
                                    </td>
