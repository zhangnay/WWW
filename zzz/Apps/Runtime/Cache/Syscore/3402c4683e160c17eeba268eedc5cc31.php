                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li><span><?php if(($rs["id"]) == ""): echo (L("v_add")); else: echo (L("v_edit")); endif; ?> <?php echo (L("v_page_module")); ?></span></li>
                        </ul>
                    </div>
                    <!--页面导航 结束-->
                    <!--页面头部 结束-->
                                    ...
                                    <div class="portlet-body">
                                        <div class="tabbable-bordered">
                                            <div class="edit_nav_left">
                                                <i class="fa fa-edit font-white"></i> <span class="font-white"><?php if(($rs["id"]) == ""): echo (L("v_add")); else: echo (L("v_edit")); endif; ?> <?php echo (L("v_page_module")); ?></span>
                                            </div>
                                                    ...
                                                    <div class="form-body">
                                                        ...
                                                        <?php if((in_array('area',$isdisplay_array))): ?><div class="form-group">
                                                                ...
                                                                <div class="col-md-9" id="area">
                                                                    <?php $__FOR_START_27693__=1;$__FOR_END_27693__=5;for($i=$__FOR_START_27693__;$i < $__FOR_END_27693__;$i+=1){ ?><select name="areaid" class="area<?php echo ($i); ?> form-control input-small input-inline" data-style="btn-primary">
                                                                            <?php if(($rs["id"]) != ""): ?><!--编辑状态-->
...
$('#area').cxSelect({
  ...
  selects: [<?php $__FOR_START_30050__=1;$__FOR_END_30050__=5;for($i=$__FOR_START_30050__;$i < $__FOR_END_30050__;$i+=1){ ?>'area<?php echo ($i); ?>'<?php if(($i) != "4"): ?>,<?php endif; } ?>],
  required: true,
  jsonName: 'areaname', 
  jsonValue: 'id', 
  jsonSub: '0', 
