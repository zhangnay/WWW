                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li><span><?php echo (L("v_global")); ?></span><i class="fa fa-angle-right"></i></li>
                            <li><span><?php echo (L("v_field")); ?> <?php echo (L("v_manage")); ?></span><i class="fa fa-angle-right"></i></li>
                            <li><span><?php if(($rs["id"]) == ""): echo (L("v_add")); else: echo (L("v_edit")); endif; ?> <?php echo (L("v_field")); ?></span></li>
                        </ul>
                    </div>
                    <!--页面导航 结束-->
                    <!--页面头部 结束-->
                                    ...
                                    <div class="portlet-body">
                                        <div class="tabbable-bordered">
                                            <div class="edit_nav_left">
                                                <i class="fa fa-edit font-white"></i> <span class="font-white"><?php if(($rs["id"]) == ""): echo (L("v_add")); else: echo (L("v_edit")); endif; ?> <?php echo (L("v_field")); ?></span>
                                            </div>
                                                ...
                                                <div class="tab-pane active" id="tab_general">
                                                    <div class="form-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3"><?php echo (L("v_field")); ?> <?php echo (L("v_label")); ?><span class="required" aria-required="true">*</span></label>
                                                            <div class="col-md-6">
                                                                <div class="input-icon right"><i class="fa"></i><input type="text" class="form-control" name="fieldlabel" value="<?php echo ($rs["fieldlabel"]); ?>" /></div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3"><?php echo (L("v_field")); ?> <?php echo (L("v_description")); ?></label>
                                                            <div class="col-md-6">
                                                                <input type="text" class="form-control" name="fieldtext" value="<?php echo ($rs["fieldtext"]); ?>" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3"><?php echo (L("v_field")); ?> <?php echo (L("v_content_a")); ?></label>
                                                            <div class="col-md-6">
                                                                <?php switch($_GET['fieldtype']): case "text": ?><input name="fieldvalue" type="text" class="form-control" value="<?php echo ($rs['fieldvalue']); ?>"><?php break;?>
                                                                    <?php case "imgupload": ?><div class="input-group"><input type="text" name="fieldvalue" id="morepics1" value="<?php echo ($rs['fieldvalue']); ?>" class="form-control" /><span class="input-group-btn"><input type="button" onClick="upImage1();" value=" <?php echo (L("v_upload_img")); ?> " class="btn green" /></span></div><?php break;?>
                                                                    <?php case "fileupload": ?><div class="input-group"><input name="fieldvalue" id="file" type="text" class="form-control" value="<?php echo ($rs['fieldvalue']); ?>" /><span class="input-group-btn"><input type="button" value=" <?php echo (L("v_upload_file")); ?> " class="btn green" onclick="upFiles();"></span></div><?php break;?>
                                                                    <?php case "richtext": ?><textarea name="fieldvalue" id="content1a" style="width:100%; height:150px;"><?php echo ($rs['fieldvalue']); ?></textarea><?php break;?>
                                                                    <?php case "textarea": ?><textarea name="fieldvalue" class="form-control" rows="5"><?php echo ($rs['fieldvalue']); ?></textarea><?php break;?>
                                                                    <?php default: ?><input name="fieldvalue" type="text" class="form-control" value="<?php echo ($rs['fieldvalue']); ?>"><?php endswitch;?>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
...
<!--图片上传结束-->
<?php if(($_GET['fieldtype']) == "richtext"): ?><!--富文本编辑器开始-->
<script type="text/javascript">
    var url='<?php echo U('Syscore/Ueditor/Index');?>';
...
var FormValidation = function () {
    ...
    var handleWysihtml5 = function() {
        ...
        if ($('.wysihtml5').size() > 0) {
            $('.wysihtml5').wysihtml5({
                "stylesheets": ["/zzz/Public/bootstrap/global/plugins/bootstrap-wysihtml5/wysiwyg-color.css"]
            });
        }
    }
